...
describe('StatsSaga', () => {
    ...
    it('fetchStats select app.view then get the data, create a delay, then get next fetchStats data', () => {
        ...
        const fetchAllStatData = call(Saga.fetchAllStatData, stats)
        expect(generator.next(stats).value).toEqual(fetchAllStatData)
